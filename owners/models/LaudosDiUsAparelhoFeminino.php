...
/**
 * This is the model class for table "laudos_di_us_aparelho_feminino".
 *
 * @property int $id
 ...
 * @property User $user
 */
class LaudosDiUsAparelhoFeminino extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'laudos_di_us_aparelho_feminino';
    }
