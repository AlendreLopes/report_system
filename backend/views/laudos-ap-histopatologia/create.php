...
/* @var $model backend\models\LaudosApHistopatologia */

$this->title = 'Cadastrar Laudo de Histopatologia';
$this->params['breadcrumbs'][] = ['label' => 'Laudos', 'url' => ['/protocolos/index']];
$this->params['breadcrumbs'][] = ['label' => 'Laudos AP Histopatologia', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="laudos-ap-histopatologia-create">
