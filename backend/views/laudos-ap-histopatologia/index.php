...
/* @var $searchModel backend\models\LaudosApHistopatologiaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Laudos AP Histopatologias';
$this->params['breadcrumbs'][] = ['label' => 'Laudos', 'url' => ['/protocolos/index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="laudos-ap-histopatologia-index">
            ...
            [
                ...
                'value'     => function ($model) {
                    return Html::a(
                        ...
                        Url::to(Url::to(['laudos-ap-histopatologia/view', 'id' => $model->id])),
