...
/* @var $searchModel app\modules\laudos\models\LaudosDiUsObstetricaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Laudos DI US Obstetrica';
$this->params['breadcrumbs'][] = ['label' => 'Laudos', 'url' => ['/protocolos/index']];
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="laudos-di-us-obstetrica-index">
            ...
            [
                ...
                'value'     => function ($model) {
                    return Html::a(
                        ...
                        Url::to(Url::to(['laudos-di-us-obstetrica/view', 'id' => $model->id])),
