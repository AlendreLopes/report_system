...
/* @var $searchModel app\modules\laudos\models\LaudosDiUsGestacionalSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Laudos DI US Gestacional';
$this->params['breadcrumbs'][] = ['label' => 'Laudos', 'url' => ['/protocolos/index']];
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="laudos-di-us-gestacional-index">
            ...
            [
                ...
                'value'     => function ($model) {
                    return Html::a(
                        ...
                        Url::to(Url::to(['laudos-di-us-gestacional/view', 'id' => $model->id])),
