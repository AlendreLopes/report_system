...
/* @var $searchModel app\modules\laudos\models\LaudosDiUsPosPartoSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Laudos DI Us Pos Parto';
$this->params['breadcrumbs'][] = ['label' => 'Laudos', 'url' => ['/protocolos/index']];
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="laudos-di-us-pos-parto-index">
            ...
            [
                ...
                'value'     => function ($model) {
                    return Html::a(
                        ...
                        Url::to(Url::to(['laudos-di-us-pos-parto/view', 'id' => $model->id])),
