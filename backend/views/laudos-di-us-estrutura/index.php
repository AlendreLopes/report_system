...
/* @var $searchModel app\modules\laudos\models\LaudosDiUsEstruturaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Laudos DI Us Estrutura';
$this->params['breadcrumbs'][] = ['label' => 'Laudos', 'url' => ['/laudos/protocolos/index']];
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="laudos-di-us-estrutura-index">

    <?php echo $this->render('@app/modules/secretaria/views/laudos-menu/menuLaudos'); ?>
            ...
            [
                ...
                'value'     => function ($model) {
                    return Html::a(
                        ...
                        Url::to(Url::to(['laudos-di-us-estrutura/view', 'id' => $model->id])),
