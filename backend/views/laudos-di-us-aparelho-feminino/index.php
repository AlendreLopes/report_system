...
/* @var $searchModel app\modules\laudos\models\LaudosDiUsAparelhoFemininoSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Laudos DI Us Aparelho Feminino';
$this->params['breadcrumbs'][] = ['label' => 'Laudos', 'url' => ['/protocolos/index']];
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="laudos-di-us-aparelho-feminino-index">
            ...
            [
                ...
                'value'     => function ($model) {
                    return Html::a(
                        ...
                        Url::to(Url::to(['laudos-di-us-aparelho-feminino/view', 'id' => $model->id])),
