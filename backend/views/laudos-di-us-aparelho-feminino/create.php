...
$this->title = 'Cadastrar Laudos DI Us Aparelho Feminino';
$this->params['breadcrumbs'][] = ['label' => 'Laudos', 'url' => ['/protocolos/index']];
$this->params['breadcrumbs'][] = ['label' => 'Laudos Di Us Aparelho Femininos', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="laudos-di-us-aparelho-feminino-create">
