...
/* @var $searchModel app\modules\laudos\models\LaudosDiRaioXSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Laudos DI Raio X';
$this->params['breadcrumbs'][] = ['label' => 'Laudos', 'url' => ['/protocolos/index']];
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="laudos-di-raio-x-index">
            ...
            [
                ...
                'value'     => function ($model) {
                    return Html::a(
                        ...
                        Url::to(Url::to(['laudos-di-raio-x/view', 'id' => $model->id])),
