...
/**
 * This is the model class for table "laudos_di_raio_x".
 *
 * @property int $id
 ...
 * @property User $user
 */
class LaudosDiRaioX extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['regiao', 'descricao'], 'required'],
            [['regiao', 'descricao', 'interpretacao', 'observacao'], 'string'],
            [['concluido'], 'safe'],
