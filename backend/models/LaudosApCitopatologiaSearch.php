...
/**
 * LaudosApCitopatologiaSearch represents the model behind the search form of `app\modules\laudos\models\LaudosApCitopatologia`.
 */
class LaudosApCitopatologiaSearch extends LaudosApCitopatologia
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        $query = LaudosApCitopatologia::find()->orderBy(['id' => SORT_DESC]);
