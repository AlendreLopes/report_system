...
use backend\models\LaudosDiUsGestacionalSearch;
...
/**
 * LaudosDiUsGestacionalController implements the CRUD actions for LaudosDiUsGestacional model.
 */
class LaudosDiUsGestacionalController extends AppController
{
    /**
     * Lists all LaudosDiUsGestacional models.
     * @return mixed
     */
    public function actionIndex()
    {
        ...
        $searchModel = new LaudosDiUsGestacionalSearch();
    ...
    /**
     * Displays a single LaudosDiUsGestacional model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Creates a new LaudosDiUsGestacional model.
    ...
    public function actionCreate()
    {
        ...
        if (LaudosDiUsGestacional::findOne(['protocolos_id' => $protocoloId])) {
        ...
        $model = new LaudosDiUsGestacional();
    ...
    /**
     * Updates an existing LaudosDiUsGestacional model.
    ...
    /**
     * Deletes an existing LaudosDiUsGestacional model.
    ...
    /**
     * Finds the LaudosDiUsGestacional model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return LaudosDiUsGestacional the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = LaudosDiUsGestacional::findOne($id)) !== null) {
            return $model;
        }
