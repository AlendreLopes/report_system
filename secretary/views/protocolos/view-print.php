<?php
    ...
    $readyToPrint = 0;
    //
    $this->title = "Impressão: " . $model->username;
...
<?php
        ...
        <table id="footer" class="table-responsive table table-striped">
            <tr>
                <td style="text-indent: 10px; text-align: justify;">
                    Prezado Cliente respons&aacute;vel pelo animal [ <strong><?= $protocolo->paciente;?></strong> ] na data de [ <strong><?= Yii::$app->formatter->asDate(date("Y-M-d"));?></strong> ].
                </td>
            </tr>
            <tr>
                <td style="text-indent: 10px; text-align: justify;">
                    Para acessar seus resultados pela internet, informe o n&uacute;mero do:
                    <br />                  
                    <strong>PROTOCOLO</strong> : <strong><?= $protocolo->username;?></strong> seguido da <strong>SENHA</strong> : <strong style="text-align: center; text-transform: uppercase;"><?= $protocolo->motedepass;?></strong>.
                    <br />
                    O endere&ccedil;o do nosso site &eacute; <strong>www.petimagem.com</strong> ou <strong>www.petimagem.com.br</strong>.<br />
                </td>
            </tr>
            <tr>
                <td style="text-indent: 10px; text-align: justify;">
                    <strong>
                        Por motivos de ordem t&eacute;cnica alguns exames poder&atilde;o ser liberados conforme sua realiza&ccedil;&atilde;o ou antes da data prevista.
                    </strong>
                </td>
            </tr>
        </table>
    ...
    if($readyToPrint){
        $this->params['breadcrumbs'][] = ['label' => 'Imprimir Laudos', 'url' => ['/protocolos/view-print-protocols', 'id' => $model->id]];
    }else{
        ...
        <div class="row">
            <div class="col-lg-12">
                <h4>Clique no botao voltar para a listagem dos Protocolos.</h4>
                <h3 style="text-align:center;"><?= Html::a("Voltar", Url::to(Url::to(['protocolos/index'])), ['title' => 'Voltar', 'class' => 'btn btn-primary']);?></h3>
            </div>
        </div>
    <?php
    }
