 ...
 * @property string $desconto Porcentagem do Desconto
 * @property float $desconto_valor Valor do Desconto
 * @property string|null $anestesia Protocolo com Anestesia
 * @property float $anestesia_valor Valor da Anestesia
 * @property string|null $isento Protocolo Isento
 * @property string|null $pago Protocolo Pago
 * @property float $valor Protocolo Valor
 * @property string $motedepass
 * @property string $motedepass_hash
...
class Protocolos extends \yii\db\ActiveRecord
{
    ...
    // Insere usuário data de cadastro e expirar
        ...
        return [
            [
                ...
                'attributes' => [
                    ...
                    'data_expira' => [
                        ActiveRecord::EVENT_BEFORE_INSERT => date("Y-m-d",strtotime("+ 6 months")),
                    ],
                ],
            ],
            [
    ...
    {
        return [
            [['convenio_id', 'numero', 'username', 'motedepass', 'requisitante', 'proprietario', 'paciente', 'especie', 'especie_raca', 'genero', 'idade', 'contato'], 'required'],
    ...
    {
        return [
            self::SCENARIO_CREATE => ['numero','username', 'motedepass', 'convenio_id', 'requisitante', 'proprietario', 'paciente', 'especie', 'especie_raca', 'genero', 'idade'],
