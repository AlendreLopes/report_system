...
/**
 * This is the model class for table "laudos_di_raio_x_contrastado".
 *
 * @property int $id
 ...
 * @property User $user
 */
class LaudosDiRaioXContrastado extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'laudos_di_raio_x_contrastado';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['protocolos_id', 'tecnica', 'descricao', 'interpretacao', 'observacao'], 'required'],
            [['descricao', 'interpretacao', 'observacao'], 'string'],
            [['concluido'], 'safe'],
            [['tecnica'], 'string', 'max' => 50],
